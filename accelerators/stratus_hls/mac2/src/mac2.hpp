...
#include "mac2_conf_info.hpp"
#include "mac2_debug_info.hpp"

#include "esp_templates.hpp"

#include "mac2_directives.hpp"
...
class mac2 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(mac2);
    mac2(const sc_module_name& name)
