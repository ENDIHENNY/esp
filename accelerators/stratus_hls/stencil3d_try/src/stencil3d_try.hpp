...
#ifndef __STENCIL3D_TRY_HPP__
#define __STENCIL3D_TRY_HPP__
...
class stencil3d_try : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(stencil3d_try);
    stencil3d_try(const sc_module_name& name)
